...
public class NVKT_PhuCap_KhenThuong_KhauTruCN_GUI extends JPanel {
	...
	private ChiTietPhuCapKhenThuongKhauTruCNDAO ctpc = new ChiTietPhuCapKhenThuongKhauTruCNDAO();
	private List<PhuCapKhenThuongKhauTru> listPCKTKT = phuCapKhenThuongKhauTruDAO.getDanhSachPCKTKTCongNhanhByMaLuongID(NVKT_TinhLuongCN.maBangLuongTable);
	...
	public NVKT_PhuCap_KhenThuong_KhauTruCN_GUI() {
		...
		btnThem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(e.getSource().equals(btnThem)) {
					ChiTietPhuCapKhenThuongKhauTruCN ct = new ChiTietPhuCapKhenThuongKhauTruCN
							(new PhuCapKhenThuongKhauTru(txtMaLoai.getText()), new BangLuongCongNhan(NVKT_TinhLuongCN.maBangLuongTable));
					if(ctpc.getChiTietKhenThuongPhuCapKhauTru(ct.getPhuCapKhenThuongKhauTru().getId(), ct.getBangLuongCongNhan().getBangLuongID()) == null) {
						ctpc.addChiTietPhuCapKhenThuongKhauTru(ct);
						listPCKTKT = phuCapKhenThuongKhauTruDAO.getDanhSachPCKTKTCongNhanhByMaLuongID(NVKT_TinhLuongCN.maBangLuongTable);
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getSource().equals(btnXoa)) {
					...
					if (rowSelect == -1)
						...
						System.out.println(ctpc.deleteChiTietPhuCapKhenThuongKhauTru(NVKT_TinhLuongCN.maBangLuongTable, table.getValueAt(rowSelect, 1).toString()));
						listPCKTKT = phuCapKhenThuongKhauTruDAO.getDanhSachByMaLuongID(NVKT_TinhLuongCN.maBangLuongTable);
						addDataTable(listPCKTKT);
					}
				}
			}
	...
	private void addDataTable(List<PhuCapKhenThuongKhauTru> list) {
		...
		txtMaNhanVien.setText(NVKT_TinhLuongCN.thongTinCongNhan.getNguoiID());
		txtHoTen.setText(NVKT_TinhLuongCN.thongTinCongNhan.getHoTen());
		txtPhongBan.setText(NVKT_TinhLuongCN.thongTinCongNhan.getBoPhan().getTenBoPhan());
		txtSoNgayCong.setText(String.valueOf(NVKT_TinhLuongCN.SNC));
		txtSoNgayCong.setText(String.valueOf(NVKT_TinhLuongCN.SNV));
		txtPhuCap.setText(convertLuongCoBan(NVKT_TinhLuongCN.tongPhuCap));
		txtKhenThuong.setText(convertLuongCoBan(NVKT_TinhLuongCN.tongKhenThuong));
		txtKhauTru.setText(convertLuongCoBan(NVKT_TinhLuongCN.tongKhauTru));
		txtLuongCoBan.setText(convertLuongCoBan(NVKT_TinhLuongCN.luongSanPham));
		txtLuongThucLanh.setText(convertLuongCoBan(NVKT_TinhLuongCN.luongThucLanh));
