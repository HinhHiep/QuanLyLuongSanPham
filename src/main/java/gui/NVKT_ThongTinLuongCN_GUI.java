...
public class NVKT_ThongTinLuongCN_GUI extends JPanel {
	...
	public NVKT_ThongTinLuongCN_GUI() {
		...
		JLabel lblNewLabel_11 = new JLabel("Bộ phận:");
	...
	private void addTableLabel() {
		textMaNV.setText(NVKT_TinhLuongCN.thongTinCongNhan.getNguoiID());
		textHoTen.setText(NVKT_TinhLuongCN.thongTinCongNhan.getHoTen());
		textMaPhieu.setText(NVKT_TinhLuongCN.maBangLuongTable);
		textThangLuong.setText("Tháng " + NVKT_TinhLuongCN.thangLuong);
		String gioiTinh;
		textGioiTinh.setText(NVKT_TinhLuongCN.thongTinCongNhan.isGioiTinh() ? "Nam" : "Nữ");
		textNgaySinh.setText(DateTimeFormatter.ofPattern("dd-MM-yyyy").format(NVKT_TinhLuongCN.thongTinCongNhan.getNgaySinh()));
		textPhongBan.setText(NVKT_TinhLuongCN.thongTinCongNhan.getBoPhan().getTenBoPhan());
		textSNKN.setText("1.5");
		textLCB.setText(convertLuongCoBan(NVKT_TinhLuongCN.luongSanPham));
		textSNC.setText(String.valueOf(NVKT_TinhLuongCN.SNC));
		textSNV.setText(String.valueOf(NVKT_TinhLuongCN.SNV));
		textLuongThucLanh.setText(convertLuongCoBan(NVKT_TinhLuongCN.luongThucLanh));
		textTongPhuCap.setText(convertLuongCoBan(NVKT_TinhLuongCN.tongPhuCap));
		textTongKhenThuong.setText(convertLuongCoBan(NVKT_TinhLuongCN.tongKhenThuong));
		textTongKhauTru.setText(convertLuongCoBan(NVKT_TinhLuongCN.tongKhauTru));
		textLuongTruocThue.setText(convertLuongCoBan(NVKT_TinhLuongCN.tongLuongTruocThue));
		textThuNhapCaNhan.setText(convertLuongCoBan(NVKT_TinhLuongCN.thueThuNhapCaNhan));
	
		textCMND.setText(NVKT_TinhLuongCN.thongTinCongNhan.getSoCMND());
		textDiaChi.setText(NVKT_TinhLuongCN.thongTinCongNhan.getDiaChi());
		textEmail.setText(NVKT_TinhLuongCN.thongTinCongNhan.getEmail());
		textSDT.setText(NVKT_TinhLuongCN.thongTinCongNhan.getSoDienThoai());
		addTableChiTietTable(NVKT_TinhLuongCN.listPCKTKT);
		
	}
	
	private static void printPDF() throws IOException {
		String path = "BangLuongCongNhan.pdf";
		...
		table.addCell(new Cell().add("Thông tin lương công nhân").setFont(customFont).setBorder(Border.NO_BORDER).setBold());
		Table nestedTable = new Table(new float[] {twocol/2, twocol/2});
		nestedTable.addCell(getHeaderTextCell("Mã bảng lương").setFont(customFont));
		nestedTable.addCell(getHeaderTextCellValue(NVKT_TinhLuongCN.maBangLuongTable).setFont(customFont));
		nestedTable.addCell(getHeaderTextCell("Tháng lương").setFont(customFont));
		nestedTable.addCell(getHeaderTextCellValue(NVKT_TinhLuongCN.thangLuong).setFont(customFont));
		...
		twoColTable2.addCell(getNhanVien10CellLeft(NVKT_TinhLuongCN.thongTinCongNhan.getNguoiID(),false).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft(convertLuongCoBan(NVKT_TinhLuongCN.tongPhuCap),false).setFont(customFont));
		...
		twoColTable2.addCell(getNhanVien10CellLeft(NVKT_TinhLuongCN.thongTinCongNhan.getHoTen(), false).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft(convertLuongCoBan(NVKT_TinhLuongCN.tongKhenThuong),false).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft("Bộ phận:",true).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft("Tổng khấu trừ: ",true).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft(NVKT_TinhLuongCN.thongTinCongNhan.getBoPhan().getTenBoPhan(),false).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft(convertLuongCoBan(NVKT_TinhLuongCN.tongKhauTru),false).setFont(customFont));	
		twoColTable2.addCell(getNhanVien10CellLeft("", true).setFont(customFont));
		...
		twoColTable2.addCell(getNhanVien10CellLeft(convertLuongCoBan(NVKT_TinhLuongCN.tongLuongTruocThue),false).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft("Lương sản phẩm: ",true).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft("Thuế thu nhập cá nhân:",true).setFont(customFont));	
		twoColTable2.addCell(getNhanVien10CellLeft(convertLuongCoBan(NVKT_TinhLuongCN.luongSanPham),false).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft(convertLuongCoBan(NVKT_TinhLuongCN.thueThuNhapCaNhan),false).setFont(customFont));	
		twoColTable2.addCell(getNhanVien10CellLeft("Hệ số làm việc: ",true).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft("Lương thực lãnh:",true).setFont(customFont));	
		twoColTable2.addCell(getNhanVien10CellLeft("1.5",false).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft(convertLuongCoBan(NVKT_TinhLuongCN.luongThucLanh),false).setFont(customFont));	
		twoColTable2.addCell(getNhanVien10CellLeft("Số ngày công:  ",true).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft("",false).setFont(customFont));	
		twoColTable2.addCell(getNhanVien10CellLeft(String.valueOf(NVKT_TinhLuongCN.SNC),false).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft("",false).setFont(customFont));	
		twoColTable2.addCell(getNhanVien10CellLeft("Số ngày vắng: ",true).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft("",false).setFont(customFont));	
		twoColTable2.addCell(getNhanVien10CellLeft(String.valueOf(NVKT_TinhLuongCN.SNV),false).setFont(customFont));
		twoColTable2.addCell(getNhanVien10CellLeft("",false).setFont(customFont));	
		...
		double tien;
		for(PhuCapKhenThuongKhauTru p : NVKT_TinhLuongCN.listPCKTKT) {
	...
	private void addTableChiTietTable(List<PhuCapKhenThuongKhauTru> list) {
		...
		for(PhuCapKhenThuongKhauTru p : list) {
			if(p.getLoai().equals("Khấu trừ")) {
				if(p.getTen().equals("Khấu trừ bảo hiểm xã hội") || p.getTen().equals("Khấu trừ bảo hiểm y tế")) {
					tien = p.getGiaTien()/100 * NVKT_TinhLuongCN.luongSanPham;
				}
				else {
					tien = p.getGiaTien()/100 * NVKT_TinhLuongCN.tongLuongTruocThue;
				}
			}		
			else
				tien = p.getGiaTien();
